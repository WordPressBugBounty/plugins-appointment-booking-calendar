...
add_action( 'init', 'cpabc_plugin_init');
...
if ($cpabc_pcode == '')
{
    if (function_exists('openssl_random_pseudo_bytes'))
        $cpabc_pcode = openssl_random_pseudo_bytes(16);
    else
        $cpabc_pcode = uniqid('cpabc');
    update_option( 'CPABC_PCODE', base64_encode($cpabc_pcode));
}
