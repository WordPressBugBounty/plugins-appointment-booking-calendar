...
= 1.3.50 =
* Datetime selection interface improved

= 1.3.51 =
* New calendar design: Modern II

= 1.3.52 =
* New calendar design: Rounded

= 1.3.53 =
* New date formats

= 1.3.54 =
* Schedule Calendar View update

= 1.3.55 =
* Compatible with WordPress 5.7

= 1.3.56 =
* Script improvements for WordPress 5.7

= 1.3.57 =
* Added Finnish language

= 1.3.58 =
* Fix to exclude fields in CSV reports

= 1.3.59 =
* Load speed optimization

= 1.3.60 =
* Improved min-date options

= 1.3.61 =
* Fix to current date availability

= 1.3.62 =
* New settings field "request address" at PayPal
...
= 1.3.83 =
* Additional nonce checks

= 1.3.84 =
* iCal fix
* Removed tags: booking form,paypal calendar,plugin,paypal bookings,paypal appointments,bookings,meeting,meet,scheduler,scheduler calendar,availability,availability calendar,agenda,reservation form,reservation calendar
...
* New edition and cancellation options
...
= 1.4.01 =
* Compatible with WP 7.9

= 1.4.02 =
* Permissions adjustments

= 1.4.03 =
* Stronger permissions verification for accesing lists
