...
<input name="cpabc_item" type="hidden" value="<?php echo intval(CP_CALENDAR_ID); ?>" />
...
<div id="normal-sortables" class="meta-box-sortables">
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
   ...
   <div style="padding:10px"><div id="caladmin"><div id="cal<?php echo intval(CP_CALENDAR_ID); ?>Container"></div></div></div>
  ...
  <div class="inside"> 
   ...
   <table class="form-table">
        ...
        <td><input type="text" onchange="abc_checkdatemin()" id="calendar_mindate" name="calendar_mindate" size="40" value="<?php echo esc_attr(cpabc_get_option('calendar_mindate',CPABC_APPOINTMENTS_DEFAULT_CALENDAR_MINDATE)); ?>" /><br />
         <em style="font-size:11px;">Examples: <?php echo esc_html(date("Y-m-d")); ?>, today, today +3 days, now +30 hours</em>
        ...
        <td>
         ...
         <em style="font-size:11px;">Examples: <?php echo esc_html(date("Y-m-d", strtotime("+6 months"))); ?>, today, today +3 days</em>
        ...
        <td>
             ...
             <select name="calendar_startyear">  
              ...
              <?php for ($y=date("Y")-3;$y<date("Y")+30;$y++) { ?>                                                                       
               <option value="<?php echo intval($y); ?>" <?php if ($value == "".intval($y)) echo ' selected="selected"'; ?>><?php echo intval($y); ?></option>
              <?php } ?>  
             </select> 
        ...
        <td>
          ...
          <select name="min_slots">
           <?php for ($k=1; $k<=22; $k++) { ?>
           <option value="<?php echo intval($k); ?>"<?php if ($option == $k) echo ' selected'; ?>><?php echo intval($k); ?></option>
           <?php } ?>
          </select>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">   
     <table class="form-table">    
        ...
        <td><input type="text" name="vs_text_submitbtn" size="40" value="<?php $label = (cpabc_get_option('vs_text_submitbtn', 'Continue')); echo esc_attr($label==''?'Continue':$label); ?>" /><br />
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">    
        ...
        <td><textarea cols="70" rows="5" name="email_notification_to_admin"><?php echo esc_textarea(cpabc_get_option('email_notification_to_admin', CPABC_APPOINTMENTS_DEFAULT_NOTIFICATION_EMAIL)); ?></textarea></td>
        </tr>
     </table>  
  </div>    
 </div>
...
<?php } ?>        
        ...
        <td><textarea cols="70" rows="5" name="email_confirmation_to_user"><?php echo esc_textarea(cpabc_get_option('email_confirmation_to_user', CPABC_APPOINTMENTS_DEFAULT_CONFIRMATION_EMAIL)); ?></textarea></td>
        </tr>                                                
     </table>  
  </div>    
 </div>
     ...
     <table class="form-table">    
        ...
        <tr valign="top">
         ...
         <td colspan="2" rowspan="">
           Preview:<br />
             <br />
            <img src="<?php echo esc_attr(cpabc_appointment_get_site_url(true)); ?>/?cpabc_app=captcha&inAdmin=1"  id="captchaimg" alt="security code" border="0"  />            
         </td> 
        </tr>             
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">  
     <table class="form-table">    
        ...
        <br /><em>Note: Hours date based in server time. Server time now is <?php echo esc_html(date("Y-m-d H:i")); ?></em>
        </td>
        </tr>
        <tr valign="top">
        ...
        <td><textarea cols="70" rows="3"  disabled readonly name="reminder_content"><?php echo esc_textarea(cpabc_get_option('reminder_content', CPABC_APPOINTMENTS_DEFAULT_REMINDER_CONTENT)); ?></textarea></td>
        </tr>                                                
     </table>
  </div>
</div>  
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">    
        ...
        <ul>Sample Format:</ul>
        <?php echo str_replace("\n", "<br />", esc_html(CPABC_APPOINTMENTS_DEFAULT_EXPLAIN_CP_CAL_CHECKBOXES)); ?>
        </th>
        <td>
...
<script type="text/javascript">
 ...
 {            
    ...
    document.getElementById("captchaimg").src= "<?php echo esc_js(cpabc_appointment_get_site_url(true)); ?>/?cpabc_app=captcha&inAdmin=1&"+qs;
 }       
 ...
 $j('#cpabc_nocodes_availmsg').load('<?php echo esc_js(cpabc_appointment_get_site_url(true)); ?>/?cpabc_app=cpabc_loadcoupons&inAdmin=1&cpabc_item=<?php echo intval(CP_CALENDAR_ID); ?>');
 $j('#cpabc_dc_subccode').click (function() {
                               ...
                               $j('#cpabc_nocodes_availmsg').load('<?php echo esc_js(cpabc_appointment_get_site_url(true)); ?>/?cpabc_app=cpabc_loadcoupons&inAdmin=1&cpabc_item=<?php echo intval(CP_CALENDAR_ID); ?>'+params);
                               $j('#cpabc_dc_code').val();
                             });
  ...
  {
     $j('#abcmindateval').load('<?php echo esc_js(cpabc_appointment_get_site_url(true)); ?>/?cpabc_app=cpabc_loadmindate&code='+encodeURIComponent(document.getElementById("calendar_mindate").value));
  }
  
  function abc_checkdatemax()                             
  {
     $j('#abcmaxdateval').load('<?php echo esc_js(cpabc_appointment_get_site_url(true)); ?>/?cpabc_app=cpabc_loadmaxdate&code='+encodeURIComponent(document.getElementById("calendar_maxdate").value)+'&code2='+encodeURIComponent(document.getElementById("calendar_mindate").value));
  }  
  abc_checkdatemax();
  abc_checkdatemin();
  ...
  function cpabc_updatemaxslots()
  {
      try
      {
          var default_request_cost = new Array(<?php echo str_replace("\'","'",esc_js($request_costs_exploded)); ?>);
          var f = document.dexconfigofrm;  
